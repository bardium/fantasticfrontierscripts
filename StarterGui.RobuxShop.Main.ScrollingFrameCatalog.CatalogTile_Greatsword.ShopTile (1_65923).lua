-- Name: ShopTile
-- Path: game:GetService("StarterGui").RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_Greatsword.ShopTile
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.26003609993495047 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_Greatsword.ShopTile
...
S_MarketplaceService_1:PromptPurchase(u1, 6380213373)
end
