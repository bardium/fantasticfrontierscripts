-- Name: ShopTile
-- Path: game:GetService("StarterGui").RobuxShop.Main.GoldTile_25M.ShopTile
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.25500330002978444 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.RobuxShop.Main.GoldTile_25M.ShopTile
