-- Name: ShopTile
-- Path: game:GetService("StarterGui").RobuxShop.Main.GoldTile_50k.ShopTile
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.26040760008618236 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.RobuxShop.Main.GoldTile_50k.ShopTile
