-- Name: ShopTile
-- Path: game:GetService("StarterGui").RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_GhostMask.ShopTile
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.2571547001134604 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_GhostMask.ShopTile
...
S_MarketplaceService_1:PromptPurchase(u1, 7609772771)
end
