-- Name: ShopTile
-- Path: game:GetService("StarterGui").RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_Spellbook.ShopTile
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.2640333999879658 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_Spellbook.ShopTile
...
S_MarketplaceService_1:PromptPurchase(u1, 6568334623)
end
