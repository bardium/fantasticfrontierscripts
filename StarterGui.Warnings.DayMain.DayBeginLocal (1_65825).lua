-- Name: DayBeginLocal
-- Path: game:GetService("StarterGui").Warnings.DayMain.DayBeginLocal
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.2525649000890553 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.Warnings.DayMain.DayBeginLocal
local u1 = game.Players.LocalPlayer
game.ReplicatedStorage.Events.DayBegin.OnClientEvent:connect((function()
if u1.Stats then
