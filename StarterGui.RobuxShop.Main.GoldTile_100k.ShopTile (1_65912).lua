-- Name: ShopTile
-- Path: game:GetService("StarterGui").RobuxShop.Main.GoldTile_100k.ShopTile
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.26334309997037053 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.RobuxShop.Main.GoldTile_100k.ShopTile
