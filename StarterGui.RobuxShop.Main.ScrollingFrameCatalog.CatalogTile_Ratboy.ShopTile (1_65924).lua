-- Name: ShopTile
-- Path: game:GetService("StarterGui").RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_Ratboy.ShopTile
-- Class: LocalScript
-- Exploit: Electron 
-- Time to decompile: 0.2575175000820309 seconds

-- Decompiled by Electron BETA [ Made By (Co) ]
-- Path: Players.FANTASTlC_FR0NTlER.PlayerGui.RobuxShop.Main.ScrollingFrameCatalog.CatalogTile_Ratboy.ShopTile
...
S_MarketplaceService_1:PromptPurchase(u1, 7234995551)
end
